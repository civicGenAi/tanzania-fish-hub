...
ADD COLUMN IF NOT EXISTS haccp_pending_approval BOOLEAN DEFAULT FALSE,
ADD COLUMN IF NOT EXISTS haccp_approved BOOLEAN DEFAULT FALSE,
ADD COLUMN IF NOT EXISTS haccp_approval_date TIMESTAMP WITH TIME ZONE,
ADD COLUMN IF NOT EXISTS haccp_approved_by UUID REFERENCES profiles(id),
...
ADD COLUMN IF NOT EXISTS gap_pending_approval BOOLEAN DEFAULT FALSE,
ADD COLUMN IF NOT EXISTS gap_approved BOOLEAN DEFAULT FALSE,
ADD COLUMN IF NOT EXISTS gap_approval_date TIMESTAMP WITH TIME ZONE,
ADD COLUMN IF NOT EXISTS gap_approved_by UUID REFERENCES profiles(id),
...
ADD COLUMN IF NOT EXISTS gmp_pending_approval BOOLEAN DEFAULT FALSE,
ADD COLUMN IF NOT EXISTS gmp_approved BOOLEAN DEFAULT FALSE,
ADD COLUMN IF NOT EXISTS gmp_approval_date TIMESTAMP WITH TIME ZONE,
ADD COLUMN IF NOT EXISTS gmp_approved_by UUID REFERENCES profiles(id),
...
ADD COLUMN IF NOT EXISTS msc_pending_approval BOOLEAN DEFAULT FALSE,
ADD COLUMN IF NOT EXISTS msc_approved BOOLEAN DEFAULT FALSE,
ADD COLUMN IF NOT EXISTS msc_approval_date TIMESTAMP WITH TIME ZONE,
ADD COLUMN IF NOT EXISTS msc_approved_by UUID REFERENCES profiles(id),
ADD COLUMN IF NOT EXISTS asc_certified BOOLEAN DEFAULT FALSE,
ADD COLUMN IF NOT EXISTS asc_cert_number TEXT,
ADD COLUMN IF NOT EXISTS asc_pending_approval BOOLEAN DEFAULT FALSE,
ADD COLUMN IF NOT EXISTS asc_approved BOOLEAN DEFAULT FALSE,
ADD COLUMN IF NOT EXISTS asc_approval_date TIMESTAMP WITH TIME ZONE,
ADD COLUMN IF NOT EXISTS asc_approved_by UUID REFERENCES profiles(id),
